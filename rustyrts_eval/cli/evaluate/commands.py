...
HISTORY_PROJECTS = [
    (
        ...
        [
            ...
            ("987067698b11db82f113ae350356cb11d1d7d1f0", (None, None), (None, None)),
            ...
            ("d0b5fb18d2f16f42743518363be8b9e0737cee56", (None, None), (None, None)),
            ...
            ("a35804b89f5b08b11304d4fa3e4ca37c9a4f6627", (None, None), (None, None)),
            ...
            ("35006e9cae904ac28ffe81e62ac2e0110346121d", (None, None), (None, None)),
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            ("68d98fcf24e84dae83fa034b7f38779496c93291", (None, None), (None, None)),
            ...
            ("3db0aed9f739fd929f8dff287fafd60883649c07", (None, None), (None, None)),
            ...
            ("b907bf355fd921f22c0cd1f4e0677ba7c6814b3b", (None, None), (None, None)),
    ...
    (
        ...
        [
            ...
            ("572f1c08b6ba43bdd57c5cb99f79a08ecd821c1c", (None, None), (None, None)),
            ("f55be75a17dab2ca23b34c45e7597fe19a5fc8e4", (None, None), (None, None)),
            ("3e1e6227ca525f8631e0bff2215fa3de1b4f4cc1", (None, None), (None, None)),
            ("12d0970f7e4c4d7f91cccb12525fceea3c4c0669", (None, None), (None, None)),
            ("9153e96e88236e2f867dee8f0f291af5cfaf90f4", (None, None), (None, None)),
            ("095843119e703a756047dfe25514fdcc93425341", (None, None), (None, None)),
            ("6746a08b442d25dc63a90ace1682ebd9ec9b50b8", (None, None), (None, None)),
            ("8ed8e4f25abc95d06487c34e0b2b85778aa6a4b4", (None, None), (None, None)),
            ("9a4553b833e8fa57a361d934c3498efa485d27c9", (None, None), (None, None)),
            ("d96c489120551d36f5bdb362ce313052350821f7", (None, None), (None, None)),
            ("461c0cc07af36fc95bafa6d5a8a9d86735fc64ff", (None, None), (None, None)),
            ("78d6b88f211cc9faf88815ce7fb1a91546cfce15", (None, None), (None, None)),
            ("de7662c852353febce09196199202ee7f6e8e6c3", (None, None), (None, None)),
            ("59bd6e2eea151f097a65f2634dc5488b3c272d92", (None, None), (None, None)),
            ("43cad21623bc5de59598a565097be9c7d8642818", (None, None), (None, None)),
            ...
            ("0448b7364666ba59b39bbd5564fe8a34b67b8f01", (None, None), (None, None)),
            ...
            ("a1a7b07ad33b7dcadedc2af26c3a5f8ef3daca27", (None, None), (None, None)),
    ...
    (
        ...
        "master",
        [
            # Some test suites in certain sub-crates kept aborting abnormally, which is why we purposefully exclude them here
            ...
            ("63bd0cdd5d534444ac65d97ea8373337ea0c827c", ("--workspace --exclude solana-bpf-loader-program --exclude solana-accounts-cluster-bench --exclude solana-cli", "--skip test_wait_for_max_stake"), ("--workspace --exclude solana-bpf-loader-program --exclude solana-accounts-cluster-bench --exclude solana-cli", "--skip test_wait_for_max_stake")),
            ...
            ("4940d530b8e5d4aa1ee4ae05aee55b44cdde3663", ("--workspace --exclude solana-bpf-loader-program", "--skip test_wait_for_max_stake --skip test_kill_partition_switch_threshold_progress --skip test_switch_threshold_uses_gossip_votes"), ("--workspace --exclude solana-bpf-loader-program", "--skip test_wait_for_max_stake --skip test_kill_partition_switch_threshold_progress --skip test_switch_threshold_uses_gossip_votes")),
            ...
            ("a3395a786aea208f81516c0e43d71c239bc0a631", ("--workspace --exclude solana-bpf-loader-program", "--skip test_wait_for_max_stake"), ("--workspace --exclude solana-bpf-loader-program", "--skip test_wait_for_max_stake")),
            ...
            ("37887d487ce9b87297d9a20dd07a89adf4c66cd5", ("--workspace --exclude solana-geyser-plugin-manager", "--skip test_wait_for_max_stake"), ("--workspace --exclude solana-geyser-plugin-manager", "--skip test_wait_for_max_stake")),
            ...
            ("4f947a0db3ff9a1622fc50527134ea7617860da8", ("--workspace --exclude solana-bpf-loader-program --exclude solana-accounts-cluster-bench --exclude solana-cli", "--skip test_wait_for_max_stake"), ("--workspace --exclude solana-bpf-loader-program --exclude solana-accounts-cluster-bench --exclude solana-cli", "--skip test_wait_for_max_stake")),
            ("a5f290a66f10a25e0c3ee004a1fcd2889eca2785", ("--workspace --exclude solana-bpf-loader-program", "--skip test_wait_for_max_stake"), ("--workspace --exclude solana-bpf-loader-program", "--skip test_wait_for_max_stake")),
