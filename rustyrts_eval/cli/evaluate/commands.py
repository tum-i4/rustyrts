...
MUTANTS_PROJECTS = [
    ("projects/mutants/orion", "master", [("cfa2c0c1e89f1ec3d2ab1ab1d57f88c1201e452c", None, None)], None),
    (
        "projects/mutants/pulldown-cmark", "master", [("967dd38554399573279855a9e124dc598a0e3200", None, None)],
        None),
    ("projects/mutants/regex", "master", [("b5ef0ec281220d9047fed199ed48c29af9749570", None, None)], None),
    ...
    ("projects/mutants/tracing", "master", [("4f1e46306d4d364fcc69691fdb29a676c7105f72", None, None)], None)
]
...
TESTING_PROJECTS = [
    ...
    ("projects/git_walk/exonum", "master", [
    ...
    ("projects/git_walk/feroxbuster", "main", [
    ...
    ("projects/git_walk/meilisearch", "main", [
    ...
    ("projects/git_walk/nushell", "main", [
    ...
    ("projects/git_walk/rayon", "master", [
    ...
    ("projects/git_walk/rust-analyzer", "master", [
    ...
    ("projects/git_walk/tantivy", "main", [
    ...
    ("projects/git_walk/wasmer", "master",
     ...
     [
         ...
         ("54b4495b3f9a9e3dd60cc1bf00d20d07eb777bab",
          "test-singlepass,test-cranelift,test-dylib,test-universal,coverage",
          "test-singlepass,test-cranelift,test-dylib,test-universal,coverage"),
         ("df30d25d3952ce4b04a75c4353fe8f90df987b1e", "test-singlepass,test-universal,coverage",
          "test-singlepass,test-universal,coverage"),
         ...
         ("3d6241236c50bf4f8f378c50abeb84b733116a00", "test-singlepass,test-cranelift,test-universal,coverage",
          "test-singlepass,test-cranelift,test-universal,coverage"),
         ("1dd6d8d3eb4f2633e1f05acce50803302f8a3498", "test-singlepass,test-jit,coverage",
          "test-singlepass,test-jit,coverage"),
         ("59b37e4b75a5b0d5cd701858defbfbc99dbace13", "test-singlepass,test-cranelift,test-universal,coverage",
          "test-singlepass,test-cranelift,test-universal,coverage")
     ]),
    ("projects/git_walk/zenoh", "master", [
    ...
    try:
        ...
        for (path, branch, commits) in projects:
            ...
            if mode == "random":
                ...
                history_walk.walk(conn, path, branch=branch, commits=commits, sequentially=sequentially)
