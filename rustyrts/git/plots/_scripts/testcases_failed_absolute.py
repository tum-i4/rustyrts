...
stripplot(df_selected, labels, y_label_selected, file_selected, ["#E37222", "#A2AD00"], hue='algorithm', single_threaded=("single" in url_git))
stripplot(df_not_selected, labels, y_label_not_selected, file_not_selected, ["#E37222", "#A2AD00"], hue='algorithm', single_threaded=("single" in url_git))
